class /ODSMFE/CL_PR_APPSTORE_MPC definition
  public
...
private section.
  ...
  methods DEFINE_APPLICATIONCONFIG
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_APPSTORE
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SERVICECONFIG
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS /ODSMFE/CL_PR_APPSTORE_MPC IMPLEMENTATION.
...
define_appstore( ).
define_serviceconfig( ).
  endmethod.


  method DEFINE_APPLICATIONCONFIG.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ApplicationConfig' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property = lo_entity_type->create_property( iv_property_name = 'Key' iv_abap_fieldname = 'PARAM_NAME' ). "#EC NOTEXT
lo_property->set_is_key( ).
lo_property->set_type_edm_string( ).
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Value' iv_abap_fieldname = 'PARAM_VALUE' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 254 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ApplicationConfigSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'AppStore' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Flush' iv_abap_fieldname = 'FLUSH' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Refresh' iv_abap_fieldname = 'REFRESH' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 1 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'AppStoreSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ServiceConfig' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'EntityType' iv_abap_fieldname = 'ENTITY_TYPE' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_true ).
lo_property->set_filterable( abap_true ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DisplayName' iv_abap_fieldname = 'DISPLAYNAME' ). "#EC NOTEXT
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ServiceConfigSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230405153414'.                  "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ClassName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'ServiceConfig'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
